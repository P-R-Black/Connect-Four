document.addEventListener('DOMContentLoaded', () => {
    ...
    for (var i = 0, len = squares.length; i < len; i++)
        ...
        (function(index) {
            ...
            squares[i].onclick = function() {
                //if the square below your current square is take, you can go on top of it
                if (squares[index + 7].classList.contains('taken')) {
                    ...
                    // If the square belwo your current square is not taken, you canot go here will appear
    ...
    function checkBoard() {
        ...
        const winningArrays = [
            ...
            //now take the 4 value sin each winningArrays and plug them into the squares
        for (let y = 0; y < winningArrays.length; y++) {
            ...
            // now check to seee if they all have the class name of player-two
    ...
    // add an eventListener to each square that will treigger the checkBoard funciton on click
